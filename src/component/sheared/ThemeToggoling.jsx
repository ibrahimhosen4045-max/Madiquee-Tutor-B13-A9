...
const ThemeToggoling = () => {
  ...
  return (
    <div className="border-2 border-[#65A662] rounded-full">
      <label className="switch transition-colors duration-300 ">
